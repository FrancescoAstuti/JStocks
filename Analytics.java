...
public class Analytics {
    ...
    /**
     * Calculate price cycles based on 10% up and down movements
     * Returns: [upDownCycles, downUpCycles]
     * - upDownCycles: Number of cycles where price went up 10% and then down 10%
     * - downUpCycles: Number of cycles where price went down 10% and then up 10%
     */
    private static int[] calculatePriceCycles(List<Double> prices) {
        ...
        enum State { NEUTRAL, UP_10, DOWN_10 }
        ...
        SwingUtilities.invokeLater(() -> {
            ...
            DefaultTableModel model = new DefaultTableModel(columns, 0) {
                ...
                public Class<?> getColumnClass(int column) {
                    if (column >= 1 && column <= 4) return Double.class;
                    return String.class;
                }
                @Override
